...
BEGIN_MESSAGE_MAP(CMapView2DBase, CView)
	...
	ON_WM_TIMER()
	ON_WM_SIZE()
	ON_COMMAND(ID_EDIT_PROPERTIES, &CMapView2DBase::OnEditProperties)
	ON_WM_KEYUP()
	ON_WM_CHAR()
	ON_WM_RBUTTONUP()
	ON_UPDATE_COMMAND_UI(ID_CREATEOBJECT, &CMapView2DBase::OnUpdateEditFunction)
	ON_WM_ERASEBKGND()
	ON_UPDATE_COMMAND_UI(ID_EDIT_PROPERTIES, &CMapView2DBase::OnUpdateEditFunction)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
