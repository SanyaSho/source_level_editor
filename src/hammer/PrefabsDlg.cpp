...
BEGIN_MESSAGE_MAP(CPrefabsDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_ADDLIBRARY, &CPrefabsDlg::OnAddlibrary)
	ON_BN_CLICKED(IDC_ADDOBJECT, &CPrefabsDlg::OnAddobject)
	ON_BN_CLICKED(IDC_EDITLIBRARY, &CPrefabsDlg::OnEditlibrary)
	ON_BN_CLICKED(IDC_EDITOBJECT, &CPrefabsDlg::OnEditobject)
	ON_BN_CLICKED(IDC_EXPORTOBJECT, &CPrefabsDlg::OnExportobject)
	ON_CBN_SELCHANGE(IDC_LIBRARIES, &CPrefabsDlg::OnSelchangeLibraries)
	ON_BN_CLICKED(IDC_REMOVELIBRARY, &CPrefabsDlg::OnRemovelibrary)
	ON_BN_CLICKED(IDC_REMOVEOBJECT, &CPrefabsDlg::OnRemoveobject)
	ON_NOTIFY(LVN_ITEMCHANGED, IDC_OBJECTS, &CPrefabsDlg::OnItemchangedObjects)
	ON_NOTIFY(LVN_ENDLABELEDIT, IDC_OBJECTS, &CPrefabsDlg::OnEndlabeleditObjects)
	ON_WM_CLOSE()
	//}}AFX_MSG_MAP
	ON_COMMAND_EX(id_EditObjectInfo, &CPrefabsDlg::HandleEditObjectPopup)
	ON_COMMAND_EX(id_EditObjectData, &CPrefabsDlg::HandleEditObjectPopup)
END_MESSAGE_MAP()
