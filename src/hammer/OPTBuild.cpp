...
BEGIN_MESSAGE_MAP(COPTBuild, CPropertyPage)
	...
	ON_BN_CLICKED(IDC_BROWSE_BSP, &COPTBuild::OnBrowseBsp)
	ON_BN_CLICKED(IDC_BROWSE_GAME, &COPTBuild::OnBrowseGame)
	ON_BN_CLICKED(IDC_BROWSE_LIGHT, &COPTBuild::OnBrowseLight)
	ON_BN_CLICKED(IDC_BROWSE_VIS, &COPTBuild::OnBrowseVis)
	ON_CBN_SELCHANGE(IDC_CONFIGS, &COPTBuild::OnSelchangeConfigs)
	ON_BN_CLICKED(IDC_PARMS_BSP, &COPTBuild::OnParmsBsp)
	ON_BN_CLICKED(IDC_PARMS_GAME, &COPTBuild::OnParmsGame)
	ON_BN_CLICKED(IDC_PARMS_LIGHT, &COPTBuild::OnParmsLight)
	ON_BN_CLICKED(IDC_PARMS_VIS, &COPTBuild::OnParmsVis)
	ON_BN_CLICKED(IDC_BROWSE_BSPDIR, &COPTBuild::OnBrowseBspdir)
	ON_COMMAND_EX_RANGE(id_InsertParmMapFileNoExt, id_InsertParmEnd, &COPTBuild::HandleInsertParm)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
