...
BEGIN_MESSAGE_MAP(CObjectProperties, CPropertySheet)
	...
	ON_WM_SHOWWINDOW()
	ON_WM_CREATE()
	ON_COMMAND(IDOK, &CObjectProperties::OnApply )
	ON_COMMAND(ID_APPLY_NOW, &CObjectProperties::OnApply )
	ON_COMMAND(IDCANCEL, &CObjectProperties::OnCancel)
	ON_COMMAND(IDI_INPUT, &CObjectProperties::OnInputs)
	ON_COMMAND(IDI_OUTPUT, &CObjectProperties::OnOutputs)
	ON_COMMAND(IDD_EDIT_INSTANCE, &CObjectProperties::OnEditInstance)
