...
BEGIN_MESSAGE_MAP(COPTGeneral, CPropertyPage)
	...
	ON_BN_CLICKED(IDC_INDEPENDENTWINDOWS, &COPTGeneral::OnIndependentwindows)
	ON_BN_CLICKED(IDC_BROWSEAUTOSAVEDIR, &COPTGeneral::OnBrowseAutosaveDir)
	ON_BN_CLICKED(IDC_ENABLEAUTOSAVE, &COPTGeneral::OnEnableAutosave)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
