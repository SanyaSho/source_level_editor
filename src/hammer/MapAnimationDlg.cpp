...
BEGIN_MESSAGE_MAP( CMapAnimationDlg, CHammerBar )
	...
	ON_WM_HSCROLL()
	ON_BN_CLICKED(IDC_ANIMATIONPLAY, &CMapAnimationDlg::OnPlay)
	ON_BN_CLICKED(IDC_ANIMATIONCREATEKEYFRAME, &CMapAnimationDlg::OnCreateKeyFrame)
	ON_UPDATE_COMMAND_UI(IDC_ANIMATIONPLAY, &CMapAnimationDlg::UpdateControl)
	ON_UPDATE_COMMAND_UI(IDC_ANIMATIONCREATEKEYFRAME, &CMapAnimationDlg::UpdateControl)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
