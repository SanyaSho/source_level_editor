...
BEGIN_MESSAGE_MAP(CFilteredComboBox, CComboBox)
	...
	ON_CONTROL_REFLECT_EX(CBN_SELCHANGE, &CFilteredComboBox::OnSelChange)
	ON_CONTROL_REFLECT_EX(CBN_EDITCHANGE, &CFilteredComboBox::OnEditChange)
	ON_CONTROL_REFLECT_EX(CBN_CLOSEUP, &CFilteredComboBox::OnCloseUp)
	ON_CONTROL_REFLECT_EX(CBN_DROPDOWN, &CFilteredComboBox::OnDropDown)
	ON_CONTROL_REFLECT_EX(CBN_SELENDOK, &CFilteredComboBox::OnSelEndOK)
	ON_WM_CTLCOLOR()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
