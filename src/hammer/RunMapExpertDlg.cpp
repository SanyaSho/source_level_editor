...
BEGIN_MESSAGE_MAP(CRunMapExpertDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_BROWSECOMMAND, &CRunMapExpertDlg::OnBrowsecommand)
	ON_LBN_SELCHANGE(IDC_COMMANDLIST, &CRunMapExpertDlg::OnSelchangeCommandlist)
	ON_BN_CLICKED(IDC_INSERTPARM, &CRunMapExpertDlg::OnInsertparm)
	ON_BN_CLICKED(IDC_MOVEDOWN, &CRunMapExpertDlg::OnMovedown)
	ON_BN_CLICKED(IDC_MOVEUP, &CRunMapExpertDlg::OnMoveup)
	ON_BN_CLICKED(IDC_NEW, &CRunMapExpertDlg::OnNew)
	ON_BN_CLICKED(IDC_NORMAL, &CRunMapExpertDlg::OnNormal)
	ON_BN_CLICKED(IDC_REMOVE, &CRunMapExpertDlg::OnRemove)
	ON_EN_UPDATE(IDC_COMMAND, &CRunMapExpertDlg::OnUpdateCommand)
	ON_EN_UPDATE(IDC_PARAMETERS, &CRunMapExpertDlg::OnUpdateParameters)
	ON_BN_CLICKED(IDC_ENSURECHECK, &CRunMapExpertDlg::OnEnsurecheck)
	ON_EN_UPDATE(IDC_ENSUREFN, &CRunMapExpertDlg::OnUpdateEnsurefn)
	ON_CBN_SELCHANGE(IDC_CONFIGURATIONS, &CRunMapExpertDlg::OnSelchangeConfigurations)
	ON_BN_CLICKED(IDC_EDITCONFIGS, &CRunMapExpertDlg::OnEditconfigs)
	ON_BN_CLICKED(IDC_USEPROCESSWND, &CRunMapExpertDlg::OnUseprocesswnd)
	ON_COMMAND_EX_RANGE(id_InsertParmMapFileNoExt, id_InsertParmEnd, &CRunMapExpertDlg::HandleInsertParm)
	ON_COMMAND_EX_RANGE(id_BrExecutable, id_BrEnd, &CRunMapExpertDlg::HandleInsertCommand)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
