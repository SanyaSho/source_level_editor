...
BEGIN_MESSAGE_MAP(CMapView2D, CMapView2DBase)
	...
	ON_WM_KEYDOWN()
	ON_COMMAND(ID_VIEW_2DXY, &CMapView2D::OnView2dxy)
	ON_COMMAND(ID_VIEW_2DYZ, &CMapView2D::OnView2dyz)
	ON_COMMAND(ID_VIEW_2DXZ, &CMapView2D::OnView2dxz)
	ON_COMMAND_EX(ID_TOOLS_ALIGNTOP, &CMapView2D::OnToolsAlign)
	ON_COMMAND_EX(ID_TOOLS_ALIGNBOTTOM, &CMapView2D::OnToolsAlign)
	ON_COMMAND_EX(ID_TOOLS_ALIGNLEFT, &CMapView2D::OnToolsAlign)
	ON_COMMAND_EX(ID_TOOLS_ALIGNRIGHT, &CMapView2D::OnToolsAlign)
	ON_COMMAND_EX(ID_FLIP_HORIZONTAL, &CMapView2D::OnFlip)
	ON_COMMAND_EX(ID_FLIP_VERTICAL, &CMapView2D::OnFlip)
#ifdef SLE //// SLE NEW - third mirroring option
	ON_COMMAND_EX(ID_FLIP_BACKFRONT, &CMapView2D::OnFlip)
#endif
	ON_UPDATE_COMMAND_UI(ID_FLIP_HORIZONTAL, &CMapView2D::OnUpdateEditSelection)
	ON_UPDATE_COMMAND_UI(ID_FLIP_VERTICAL, &CMapView2D::OnUpdateEditSelection)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_ALIGNTOP, &CMapView2D::OnUpdateEditSelection)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_ALIGNBOTTOM, &CMapView2D::OnUpdateEditSelection)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_ALIGNLEFT, &CMapView2D::OnUpdateEditSelection)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_ALIGNRIGHT, &CMapView2D::OnUpdateEditSelection)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
