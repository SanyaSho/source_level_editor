...
BEGIN_MESSAGE_MAP( CFaceSmoothingDlg, CDialog )
	...
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_1, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_2, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_3, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_4, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_5, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_6, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_7, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_8, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_9, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_10, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_11, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_12, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_13, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_14, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_15, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_16, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_17, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_18, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_19, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_20, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_21, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_22, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_23, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_24, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_25, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_26, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_27, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_28, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_29, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_30, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_31, &CFaceSmoothingDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SMOOTHING_GROUP_32, &CFaceSmoothingDlg::OnButtonGroup )
...
BEGIN_MESSAGE_MAP( CFaceSmoothingVisualDlg, CDialog )
	...
	ON_COMMAND_EX( ID_SG_VISUAL_1, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_2, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_3, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_4, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_5, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_6, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_7, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_8, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_9, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_10, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_11, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_12, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_13, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_14, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_15, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_16, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_17, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_18, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_19, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_20, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_21, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_22, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_23, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_24, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_25, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_26, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_27, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_28, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_29, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_30, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_31, &CFaceSmoothingVisualDlg::OnButtonGroup )
	ON_COMMAND_EX( ID_SG_VISUAL_32, &CFaceSmoothingVisualDlg::OnButtonGroup )
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
