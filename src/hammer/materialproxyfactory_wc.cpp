...
#define REGISTER_PROXY( className, proxyName )           \
	static IMaterialProxy *__Create##proxyName##_proxy() \
	{                                                    \
...
public:
	...
	float GetAnimationStartTime( void *pBaseEntity ) override
	{
		return 0.f;
	}
};
	...
	void OnBind( void *pC_BaseEntity )
	{
		...
		/*
				...
				case TF_TEAM_RED:
					...
					break;
				default: // Mimic the old logic
				case TF_TEAM_BLUE:
					vResult = Vector( 7, 5, 1 );
					break;
				case TF_TEAM_GREEN:
					vResult = Vector( 7, 5, 1 ); // TODO: Replace this with a real color!
					break;
				case TF_TEAM_YELLOW:
					vResult = Vector( 6, 9, 2 ); // TODO: Replace this with a real color!
					break;
				case TF_TEAM_NEUTRAL:
					vResult = Vector( 10, 10, 10 );
					break;
				}
		*/
