...
BEGIN_MESSAGE_MAP(CDispNoiseDlg, CDialog)
	...
	ON_NOTIFY( UDN_DELTAPOS, ID_DISP_NOISE_MIN_SPIN, &CDispNoiseDlg::OnSpinUpDown )
	ON_NOTIFY( UDN_DELTAPOS, ID_DISP_NOISE_MAX_SPIN, &CDispNoiseDlg::OnSpinUpDown )
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
BEGIN_MESSAGE_MAP(CDispPaintDistDlg, CDialog)
	...
	ON_BN_CLICKED( ID_DISP_PAINT_DIST_RAISELOWER, &CDispPaintDistDlg::OnEffectRaiseLowerGeo )
	ON_BN_CLICKED( ID_DISP_PAINT_DIST_RAISETO, &CDispPaintDistDlg::OnEffectRaiseToGeo )
	ON_BN_CLICKED( ID_DISP_PAINT_DIST_SMOOTH, &CDispPaintDistDlg::OnEffectSmoothGeo )
#ifdef SLE //// SLE NEW - disp free drag brush
	ON_BN_CLICKED( ID_DISP_PAINT_FREE_DRAG, &CDispPaintDistDlg::OnEffectFreeDrag)
#endif
	ON_BN_CLICKED( ID_DISPPAINT_SOFTEDGE, &CDispPaintDistDlg::OnBrushTypeSoftEdge )
	ON_BN_CLICKED( ID_DISPPAINT_HARDEDGE, &CDispPaintDistDlg::OnBrushTypeHardEdge )

	ON_BN_CLICKED( ID_DISP_PAINT_DIST_SPATIAL, &CDispPaintDistDlg::OnCheckSpatial )
	ON_BN_CLICKED( ID_DISP_PAINT_DIST_AUTOSEW, &CDispPaintDistDlg::OnCheckAutoSew )

	ON_CBN_SELCHANGE( ID_DISP_PAINT_DIST_BRUSH, &CDispPaintDistDlg::OnComboBoxBrushGeo )
	ON_CBN_SELCHANGE( ID_DISP_PAINT_DIST_AXIS, &CDispPaintDistDlg::OnComboBoxAxis )

	ON_WM_HSCROLL()
	ON_EN_CHANGE( ID_DISP_PAINT_DIST_EDIT_DISTANCE, &CDispPaintDistDlg::OnEditDistance )
	ON_EN_CHANGE( ID_DISP_PAINT_DIST_EDIT_RADIUS, &CDispPaintDistDlg::OnEditRadius )
...
BEGIN_MESSAGE_MAP(CDispPaintDataDlg, CDialog)
	...
	ON_BN_CLICKED(ID_DISP_PAINT_DATA_RAISELOWER, &CDispPaintDataDlg::OnEffectRaiseLowerData)
	ON_BN_CLICKED(ID_DISP_PAINT_DATA_RAISETO, &CDispPaintDataDlg::OnEffectRaiseToData)
//	ON_BN_CLICKED(ID_DISP_PAINT_DATA_SMOOTH, &CDispPaintDataDlg::OnEffectSmoothData)

	ON_CBN_SELCHANGE(ID_DISP_PAINT_DATA_BRUSH, &CDispPaintDataDlg::OnComboBoxBrushData)
	ON_CBN_SELCHANGE(ID_DISP_PAINT_DATA_TYPE, &CDispPaintDataDlg::OnComboBoxType)

	ON_WM_HSCROLL()
	ON_EN_CHANGE(ID_DISP_PAINT_DATA_EDIT_VALUE, &CDispPaintDataDlg::OnEditValue)
...
BEGIN_MESSAGE_MAP(CPaintSculptDlg, CDialog)
	...
	ON_BN_CLICKED( ID_DISP_PAINT_DIST_AUTOSEW, &CPaintSculptDlg::OnCheckAutoSew )
	ON_WM_CLOSE()
	ON_WM_DESTROY()	
