...
BEGIN_MESSAGE_MAP(CMapDoc, CDocument)
	//{{AFX_MSG_MAP(CMapDoc)
	ON_COMMAND(ID_EDIT_DELETE, &CMapDoc::OnEditDelete)
	ON_COMMAND(ID_MAP_SNAPTOGRID, &CMapDoc::OnMapSnaptogrid)
	ON_UPDATE_COMMAND_UI(ID_MAP_SNAPTOGRID, &CMapDoc::OnUpdateMapSnaptogrid)
#ifdef SLE
	ON_COMMAND(ID_MAP_ROTATIONPIVOT, &CMapDoc::OnMapUseRotationPivot) //// SLE NEW: rotation pivot
	ON_UPDATE_COMMAND_UI(ID_MAP_ROTATIONPIVOT, &CMapDoc::OnUpdateMapUseRotationPivot)
	ON_COMMAND(ID_MAP_ROTATIONPIVOTCENTER, &CMapDoc::OnMapCenterRotationPivot)
	ON_COMMAND(ID_MAP_ROTATIONPIVOTRESET, &CMapDoc::OnMapResetRotationPivot)
	ON_COMMAND(ID_EDIT_PASTE_ALIGN, &CMapDoc::OnEditPasteAlign) //// SLE NEW: Shift + V pastes the copied object while aligning it on the surface, 3d view only
	ON_UPDATE_COMMAND_UI(ID_EDIT_PASTE_ALIGN, &CMapDoc::OnUpdateEditPasteAlign)
#endif
	ON_COMMAND(ID_MAP_ENTITY_GALLERY, &CMapDoc::OnMapEntityGallery)
	ON_COMMAND(ID_EDIT_APPLYTEXTURE, &CMapDoc::OnEditApplytexture)
	ON_COMMAND(ID_TOOLS_SUBTRACTSELECTION, &CMapDoc::OnToolsSubtractselection)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_SUBTRACTSELECTION, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND(ID_MAP_ENABLELIGHTPREVIEW, &CMapDoc::OnEnableLightPreview)
	ON_COMMAND(ID_ENABLE_LIGHT_PREVIEW_CUSTOM_FILENAME, &CMapDoc::OnEnableLightPreviewCustomFilename)
	ON_COMMAND(ID_MAP_DISABLELIGHTPREVIEW, &CMapDoc::OnDisableLightPreview)
	ON_COMMAND(ID_MAP_UPDATELIGHTPREVIEW, &CMapDoc::OnUpdateLightPreview)
	ON_COMMAND(ID_MAP_TOGGLELIGHTPREVIEW, &CMapDoc::OnToggleLightPreview)
	ON_COMMAND(ID_MAP_ABORTLIGHTCALCULATION, &CMapDoc::OnAbortLightCalculation)
	ON_COMMAND(ID_EDIT_COPYWC, &CMapDoc::OnEditCopy)
	ON_UPDATE_COMMAND_UI(ID_EDIT_COPYWC, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND(ID_EDIT_PASTEWC, &CMapDoc::OnEditPaste)
	ON_UPDATE_COMMAND_UI(ID_EDIT_PASTEWC, &CMapDoc::OnUpdateEditPaste)
	ON_COMMAND(ID_EDIT_CUTWC, &CMapDoc::OnEditCut)
	ON_UPDATE_COMMAND_UI(ID_EDIT_CUTWC, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND(ID_TOOLS_GROUP, &CMapDoc::OnToolsGroup)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_GROUP, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND(ID_TOOLS_UNGROUP, &CMapDoc::OnToolsUngroup)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_UNGROUP, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND(ID_VIEW_GRID, &CMapDoc::OnViewGrid)
	ON_UPDATE_COMMAND_UI(ID_VIEW_GRID, &CMapDoc::OnUpdateViewGrid)
	ON_COMMAND(ID_VIEW_LOGICAL_GRID, &CMapDoc::OnViewLogicalGrid)
	ON_UPDATE_COMMAND_UI(ID_VIEW_LOGICAL_GRID, &CMapDoc::OnUpdateViewLogicalGrid)
	ON_COMMAND(ID_EDIT_SELECTALL, &CMapDoc::OnEditSelectall)
	ON_UPDATE_COMMAND_UI(ID_EDIT_SELECTALL, &CMapDoc::OnUpdateEditFunction)
	ON_COMMAND(ID_EDIT_REPLACE, &CMapDoc::OnEditReplace)
	ON_UPDATE_COMMAND_UI(ID_EDIT_REPLACE, &CMapDoc::OnUpdateEditFunction)
	ON_COMMAND(ID_FILE_SAVE_AS, &CMapDoc::OnFileSaveAs)
	ON_COMMAND(ID_FILE_SAVE, &CMapDoc::OnFileSave)
	ON_COMMAND(ID_MAP_GRIDLOWER, &CMapDoc::OnMapGridlower)
	ON_COMMAND(ID_MAP_GRIDHIGHER, &CMapDoc::OnMapGridhigher)
#ifdef SLE //// SLE NEW: drop-down for all grid sizes
	ON_COMMAND(ID_MAP_GRID_0125, &CMapDoc::OnMapGrid0125)
	ON_COMMAND(ID_MAP_GRID_0250, &CMapDoc::OnMapGrid0250)
	ON_COMMAND(ID_MAP_GRID_0500, &CMapDoc::OnMapGrid0500)
	ON_COMMAND(ID_MAP_GRID_1, &CMapDoc::OnMapGrid1)
	ON_COMMAND(ID_MAP_GRID_2, &CMapDoc::OnMapGrid2)
	ON_COMMAND(ID_MAP_GRID_4, &CMapDoc::OnMapGrid4)
	ON_COMMAND(ID_MAP_GRID_8, &CMapDoc::OnMapGrid8)
	ON_COMMAND(ID_MAP_GRID_16, &CMapDoc::OnMapGrid16)
	ON_COMMAND(ID_MAP_GRID_32, &CMapDoc::OnMapGrid32)
	ON_COMMAND(ID_MAP_GRID_64, &CMapDoc::OnMapGrid64)
	ON_COMMAND(ID_MAP_GRID_128, &CMapDoc::OnMapGrid128)
	ON_COMMAND(ID_MAP_GRID_256, &CMapDoc::OnMapGrid256)
	ON_COMMAND(ID_MAP_GRID_512, &CMapDoc::OnMapGrid512)
	ON_COMMAND(ID_MAP_GRID_1024, &CMapDoc::OnMapGrid1024)
	ON_COMMAND(ID_MAP_GRID_2048, &CMapDoc::OnMapGrid2048)
	ON_UPDATE_COMMAND_UI(ID_MAP_GRID_0125, &CMapDoc::OnUpdateMapGridChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_GRID_0250, &CMapDoc::OnUpdateMapGridChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_GRID_0500, &CMapDoc::OnUpdateMapGridChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_GRID_1, &CMapDoc::OnUpdateMapGridChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_GRID_2, &CMapDoc::OnUpdateMapGridChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_GRID_4, &CMapDoc::OnUpdateMapGridChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_GRID_8, &CMapDoc::OnUpdateMapGridChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_GRID_16, &CMapDoc::OnUpdateMapGridChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_GRID_32, &CMapDoc::OnUpdateMapGridChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_GRID_64, &CMapDoc::OnUpdateMapGridChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_GRID_256, &CMapDoc::OnUpdateMapGridChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_GRID_512, &CMapDoc::OnUpdateMapGridChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_GRID_1024, &CMapDoc::OnUpdateMapGridChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_GRID_2048, &CMapDoc::OnUpdateMapGridChoices)
	// and for snap angles
	ON_COMMAND(ID_MAP_SNAPANGLE_025, &CMapDoc::OnMapSnapAngle025)
	ON_COMMAND(ID_MAP_SNAPANGLE_050, &CMapDoc::OnMapSnapAngle050)
	ON_COMMAND(ID_MAP_SNAPANGLE_100, &CMapDoc::OnMapSnapAngle100)
	ON_COMMAND(ID_MAP_SNAPANGLE_250, &CMapDoc::OnMapSnapAngle250)
	ON_COMMAND(ID_MAP_SNAPANGLE_500, &CMapDoc::OnMapSnapAngle500)
	ON_COMMAND(ID_MAP_SNAPANGLE_750, &CMapDoc::OnMapSnapAngle750)
	ON_COMMAND(ID_MAP_SNAPANGLE_15, &CMapDoc::OnMapSnapAngle15)
	ON_UPDATE_COMMAND_UI(ID_MAP_SNAPANGLE_025, &CMapDoc::OnUpdateMapAngleChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_SNAPANGLE_050, &CMapDoc::OnUpdateMapAngleChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_SNAPANGLE_100, &CMapDoc::OnUpdateMapAngleChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_SNAPANGLE_250, &CMapDoc::OnUpdateMapAngleChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_SNAPANGLE_500, &CMapDoc::OnUpdateMapAngleChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_SNAPANGLE_750, &CMapDoc::OnUpdateMapAngleChoices)
	ON_UPDATE_COMMAND_UI(ID_MAP_SNAPANGLE_15, &CMapDoc::OnUpdateMapAngleChoices)
#endif
	ON_COMMAND(ID_EDIT_TOWORLD, &CMapDoc::OnEditToWorld)
	ON_UPDATE_COMMAND_UI(ID_EDIT_TOWORLD, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND(ID_FILE_EXPORT, &CMapDoc::OnFileExport)
	ON_COMMAND(ID_FILE_EXPORTAGAIN, &CMapDoc::OnFileExportAgain)
	ON_COMMAND(ID_EDIT_MAPPROPERTIES, &CMapDoc::OnEditMapproperties)
	ON_UPDATE_COMMAND_UI(ID_EDIT_MAPPROPERTIES, &CMapDoc::OnUpdateEditFunction)
	ON_COMMAND(ID_FILE_CONVERT_WAD, &CMapDoc::OnFileConvertWAD)
	ON_UPDATE_COMMAND_UI(ID_FILE_CONVERT_WAD, &CMapDoc::OnUpdateFileConvertWAD)
	ON_COMMAND(ID_FILE_RUNMAP, &CMapDoc::OnFileRunmap)
	ON_COMMAND(ID_TOOLS_HIDEITEMS, &CMapDoc::OnToolsHideitems)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_HIDEITEMS, &CMapDoc::OnUpdateToolsHideitems)
	ON_COMMAND(ID_VIEW_HIDEUNCONNECTED, &CMapDoc::OnViewHideUnconnectedEntities)
	ON_UPDATE_COMMAND_UI(ID_VIEW_HIDEUNCONNECTED, &CMapDoc::OnUpdateViewHideUnconnectedEntities)
	ON_COMMAND(ID_TOOLS_HIDE_ENTITY_NAMES, &CMapDoc::OnToolsHideEntityNames)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_HIDE_ENTITY_NAMES, &CMapDoc::OnUpdateToolsHideEntityNames)
	ON_UPDATE_COMMAND_UI(ID_EDIT_DELETE, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND(ID_MAP_INFORMATION, &CMapDoc::OnMapInformation)
	ON_COMMAND(ID_VIEW_CENTERONSELECTION, &CMapDoc::OnViewCenterOnSelection)
	ON_COMMAND(ID_VIEW_CENTER3DVIEWSONSELECTION, &CMapDoc::OnViewCenter3DViewsOnSelection)
	ON_COMMAND(ID_EDIT_PASTESPECIAL, &CMapDoc::OnEditPastespecial)
	ON_UPDATE_COMMAND_UI(ID_EDIT_PASTESPECIAL, &CMapDoc::OnUpdateEditPastespecial)
	ON_COMMAND(ID_EDIT_SELNEXT, &CMapDoc::OnEditSelnext)
	ON_COMMAND(ID_EDIT_SELPREV, &CMapDoc::OnEditSelprev)
	ON_COMMAND(ID_EDIT_SELNEXT_CASCADING, &CMapDoc::OnEditSelnextCascading)
	ON_COMMAND(ID_EDIT_SELPREV_CASCADING, &CMapDoc::OnEditSelprevCascading)
	ON_COMMAND(ID_LOGICALOBJECT_MOVETOGETHER, &CMapDoc::OnLogicalMoveBlock)
	ON_COMMAND(ID_LOGICALOBJECT_SELECTALLCASCADING, &CMapDoc::OnLogicalSelectAllCascading)	
	ON_COMMAND(ID_LOGICALOBJECT_SELECTALLCONNECTED, &CMapDoc::OnLogicalSelectAllConnected)	
	ON_COMMAND_EX(ID_VIEW_HIDESELECTEDOBJECTS, &CMapDoc::OnViewHideObjects)
	ON_COMMAND(ID_MAP_CHECK, &CMapDoc::OnMapCheck)
	ON_COMMAND(ID_VIEW_SHOWCONNECTIONS, &CMapDoc::OnViewShowconnections)
	ON_UPDATE_COMMAND_UI(ID_VIEW_SHOWCONNECTIONS, &CMapDoc::OnUpdateViewShowconnections)
	ON_UPDATE_COMMAND_UI(ID_FILE_SAVE, &CMapDoc::OnUpdateFileSave)
	ON_COMMAND(ID_TOOLS_CREATEPREFAB, &CMapDoc::OnToolsCreateprefab)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_CREATEPREFAB, &CMapDoc::OnUpdateEditSelection)
#ifdef SLE
	ON_COMMAND(ID_TOOLS_CREATEINSTANCE, &CMapDoc::OnToolsCreateInstance) //// SLE NEW - save current selection as instance
	ON_UPDATE_COMMAND_UI(ID_TOOLS_CREATEINSTANCE, &CMapDoc::OnUpdateEditSelection) //// SLE NEW - save current selection as instance
#endif
	ON_COMMAND(ID_INSERTPREFAB_ORIGINAL, &CMapDoc::OnInsertprefabOriginal)
	ON_COMMAND(ID_EDIT_REPLACETEX, &CMapDoc::OnEditReplacetex)
	ON_UPDATE_COMMAND_UI(ID_EDIT_REPLACETEX, &CMapDoc::OnUpdateEditFunction)
	ON_COMMAND(ID_TOOLS_HOLLOW, &CMapDoc::OnToolsHollow)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_HOLLOW, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND(ID_TOOLS_SNAPSELECTEDTOGRID, &CMapDoc::OnToolsSnapselectedtogrid)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_SNAPSELECTEDTOGRID, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND(ID_TOOLS_SNAP_SELECTED_TO_GRID_INDIVIDUALLY, &CMapDoc::OnToolsSnapSelectedToGridIndividually)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_SNAP_SELECTED_TO_GRID_INDIVIDUALLY, &CMapDoc::OnUpdateEditSelection)
#ifdef SLE
	ON_COMMAND(IDC_KEEPPASTEGROUP, &CMapDoc::OnToggleKeepPasteGroup) //// SLE NEW - option to copy-paste while keeping the visgroup
	ON_UPDATE_COMMAND_UI(IDC_KEEPPASTEGROUP, &CMapDoc::OnUpdateKeepPasteGroup)
	ON_COMMAND(IDC_KEEPCLONEGROUP, &CMapDoc::OnToggleKeepCloneGroup) //// SLE NEW - menu toggle for keeping visgroup on clone-dragging
	ON_UPDATE_COMMAND_UI(IDC_KEEPCLONEGROUP, &CMapDoc::OnUpdateKeepCloneGroup)
#endif
	ON_COMMAND(ID_TOOLS_SPLITFACE, &CMapDoc::OnToolsSplitface)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_SPLITFACE, &CMapDoc::OnUpdateToolsSplitface)
	ON_COMMAND(ID_TOOLS_TRANSFORM, &CMapDoc::OnToolsTransform)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_TRANSFORM, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND(ID_TOOLS_TOGGLETEXLOCK, &CMapDoc::OnToolsToggletexlock)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_TOGGLETEXLOCK, &CMapDoc::OnUpdateToolsToggletexlock)
	ON_COMMAND(ID_TOOLS_TOGGLETEXLOCKSCALE, &CMapDoc::OnToolsToggletexlockScale)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_TOGGLETEXLOCKSCALE, &CMapDoc::OnUpdateToolsToggletexlockScale)
	ON_COMMAND(ID_TOOLS_TEXTUREALIGN, &CMapDoc::OnToolsTextureAlignment)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_TEXTUREALIGN, &CMapDoc::OnUpdateToolsTextureAlignment)
#ifdef SLE
	ON_COMMAND(ID_TOOLS_DISPVERTEXLOCK, &CMapDoc::OnToolsDispVertexLock)  //// SLE NEW: button toggle, works as holding shift w/ moving vertices in disp tool. (locks selection on vertex until you let go lmb)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_DISPVERTEXLOCK, &CMapDoc::OnUpdateToolsDispVertexLock)
#endif
	ON_COMMAND(ID_TOGGLE_CORDON, &CMapDoc::OnToggleCordon)
	ON_UPDATE_COMMAND_UI(ID_TOGGLE_CORDON, &CMapDoc::OnUpdateToggleCordon)
	ON_COMMAND_EX(ID_VIEW_HIDENONSELECTEDOBJECTS, &CMapDoc::OnViewHideObjects)
	ON_UPDATE_COMMAND_UI(ID_VIEW_HIDENONSELECTEDOBJECTS, &CMapDoc::OnUpdateViewHideUnselectedObjects)
	ON_UPDATE_COMMAND_UI(ID_VIEW_SHOW_HELPERS, &CMapDoc::OnUpdateViewShowHelpers)
	ON_COMMAND(ID_VIEW_SHOW_HELPERS, &CMapDoc::OnViewShowHelpers)
	ON_COMMAND(ID_VIEW_SHOWMODELSIN2D, &CMapDoc::OnViewShowModelsIn2D)
	ON_UPDATE_COMMAND_UI(ID_VIEW_SHOWMODELSIN2D, &CMapDoc::OnUpdateViewShowModelsIn2D)
#ifdef SLE
	ON_COMMAND(ID_VIEW_RENDERSPRITESIN3D, &CMapDoc::OnViewRenderSpritesIn3D) //// SLE NEW: allow to hide sprites in 3d (only show the little cube and not the glowing texture)
	ON_UPDATE_COMMAND_UI(ID_VIEW_RENDERSPRITESIN3D, &CMapDoc::OnUpdateViewRenderSpritesIn3D)
#endif
	ON_COMMAND(ID_VIEW_PREVIEW_MODEL_FADE, &CMapDoc::OnViewPreviewModelFade)
	ON_UPDATE_COMMAND_UI(ID_VIEW_PREVIEW_MODEL_FADE, &CMapDoc::OnUpdateViewPreviewModelFade)
	ON_COMMAND(ID_COLLISION_WIREFRAME, &CMapDoc::OnCollisionWireframe)
	ON_UPDATE_COMMAND_UI(ID_COLLISION_WIREFRAME, &CMapDoc::OnUpdateCollisionWireframe)
	ON_COMMAND(ID_SHOW_DETAIL_OBJECTS, &CMapDoc::OnShowDetailObjects)
	ON_UPDATE_COMMAND_UI(ID_SHOW_DETAIL_OBJECTS, &CMapDoc::OnUpdateShowDetailObjects)
	ON_COMMAND(ID_SHOW_NODRAW_BRUSHES, &CMapDoc::OnShowNoDrawBrushes)
	ON_UPDATE_COMMAND_UI(ID_SHOW_NODRAW_BRUSHES, &CMapDoc::OnUpdateShowNoDrawBrushes)
#ifdef SLE
	ON_COMMAND(ID_SHOW_TOOLBRUSH_FACES, &CMapDoc::OnShowToolBrushFaces) //// SLE NEW: Tool Brush Texture display filter/toogle.
	ON_UPDATE_COMMAND_UI(ID_SHOW_TOOLBRUSH_FACES, &CMapDoc::OnUpdateShowToolBrushFaces)
	ON_COMMAND(ID_SHOW_EDITOR_OBJECTS, &CMapDoc::OnShowEditorObjects) //// SLE NEW: Editor Objects display filter/toogle.
	ON_UPDATE_COMMAND_UI(ID_SHOW_EDITOR_OBJECTS, &CMapDoc::OnUpdateShowEditorObjects)
	ON_COMMAND(ID_SHOW_TOOLSSKY_FACES, &CMapDoc::OnShowToolsSkyFaces) //// SLE NEW: ToolsSky Texture display filter/toogle.
	ON_UPDATE_COMMAND_UI(ID_SHOW_TOOLSSKY_FACES, &CMapDoc::OnUpdateShowToolsSkyFaces)
	ON_COMMAND(ID_PLAY_MODEL_ANIMATIONS, &CMapDoc::OnPlayModelAnimations) //// SLE NEW: Easy menu key to toggle model animations on/off.
	ON_UPDATE_COMMAND_UI(ID_PLAY_MODEL_ANIMATIONS, &CMapDoc::OnUpdatePlayModelAnimations)
	ON_COMMAND(ID_SHOW_SOLID_EDGES_NOZ, &CMapDoc::OnShowSolidEdgesNoZ) //// SLE NEW - option to render selected solids' edges in wireframe noz
	ON_UPDATE_COMMAND_UI(ID_SHOW_SOLID_EDGES_NOZ, &CMapDoc::OnUpdateShowSolidEdgesNoZ)
#endif
	ON_COMMAND(ID_TOGGLE_GROUPIGNORE, &CMapDoc::OnToggleGroupIgnore)
	ON_UPDATE_COMMAND_UI(ID_TOGGLE_GROUPIGNORE, &CMapDoc::OnUpdateToggleGroupIgnore)
#ifdef SLE
	ON_COMMAND(ID_CYCLE_GROUPOBJECTSSOLIDS, &CMapDoc::OnCycleSelectionMode)
	ON_UPDATE_COMMAND_UI(ID_CYCLE_GROUPOBJECTSSOLIDS, &CMapDoc::OnUpdateCycleSelectionMode)
#endif
	ON_COMMAND(ID_VSCALE_TOGGLE, &CMapDoc::OnVscaleToggle)
	ON_COMMAND(ID_MAP_ENTITYREPORT, &CMapDoc::OnMapEntityreport)
#ifdef SLE
	ON_COMMAND(ID_TOGGLE_15DEGSNAP, &CMapDoc::OnToggle15DegSnap) //// SLE NEW: quick access via hotkey for the 15 degrees rotation snap option.
	ON_UPDATE_COMMAND_UI(ID_TOGGLE_15DEGSNAP, &CMapDoc::OnUpdate15DegSnap)
#endif
	ON_COMMAND(ID_TOGGLE_SELECTBYHANDLE, &CMapDoc::OnToggleSelectbyhandle)
	ON_UPDATE_COMMAND_UI(ID_TOGGLE_SELECTBYHANDLE, &CMapDoc::OnUpdateToggleSelectbyhandle)
	ON_COMMAND(ID_TOGGLE_INFINITESELECT, &CMapDoc::OnToggleInfiniteselect)
	ON_UPDATE_COMMAND_UI(ID_TOGGLE_INFINITESELECT, &CMapDoc::OnUpdateToggleInfiniteselect)
	ON_COMMAND(ID_FILE_EXPORTTODXF, &CMapDoc::OnFileExportDXF)
#ifdef SLE
	ON_COMMAND(ID_FILE_EXPORTTOSMD, &CMapDoc::OnFileExportSMDNoCollisions) //// SLE TODO - SMD export
	ON_COMMAND(ID_FILE_EXPORTCOLLTOSMD, &CMapDoc::OnFileExportSMDCollisions) //// SLE TODO - SMD export
	ON_COMMAND(ID_FILE_EXPORTTOMAP, &CMapDoc::OnFileExportMAP) //// SLE NEW: add export to MAP to Tools->Export
	ON_COMMAND(ID_FILE_EXPORTTOTXT, &CMapDoc::OnFileExportCommentary) //// SLE NEW: add exporting commentary nodes to txt
#endif
	ON_UPDATE_COMMAND_UI(ID_EDIT_APPLYTEXTURE, &CMapDoc::OnUpdateEditApplytexture)
	ON_COMMAND(ID_EDIT_CLEARSELECTION, &CMapDoc::OnEditClearselection)
	ON_UPDATE_COMMAND_UI(ID_EDIT_CLEARSELECTION, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND(ID_TOOLS_CENTER_ORIGINS, &CMapDoc::OnToolsCenterOrigins)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_CENTER_ORIGINS, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND(ID_MAP_LOADPOINTFILE, &CMapDoc::OnMapLoadpointfile)
	ON_COMMAND(ID_MAP_UNLOADPOINTFILE, &CMapDoc::OnMapUnloadpointfile)
	ON_COMMAND(ID_MAP_LOADPORTALFILE, &CMapDoc::OnMapLoadportalfile)
	ON_COMMAND(ID_MAP_UNLOADPORTALFILE, &CMapDoc::OnMapUnloadportalfile)
	ON_COMMAND(ID_TOGGLE_3D_GRID, &CMapDoc::OnToggle3DGrid)
	ON_UPDATE_COMMAND_UI(ID_TOGGLE_3D_GRID, &CMapDoc::OnUpdateToggle3DGrid)
	ON_COMMAND(ID_EDIT_TOENTITY, &CMapDoc::OnEditToEntity)
	ON_UPDATE_COMMAND_UI(ID_EDIT_TOENTITY, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND_EX(ID_EDIT_UNDO, &CMapDoc::OnUndoRedo)
	ON_COMMAND_EX(ID_EDIT_REDO, &CMapDoc::OnUndoRedo)
	ON_UPDATE_COMMAND_UI(ID_EDIT_UNDO, &CMapDoc::OnUpdateUndoRedo)
	ON_UPDATE_COMMAND_UI(ID_EDIT_REDO, &CMapDoc::OnUpdateUndoRedo)
	ON_COMMAND(ID_GOTO_BRUSH, &CMapDoc::OnViewGotoBrush)
	ON_COMMAND(ID_GOTO_COORDS, &CMapDoc::OnViewGotoCoords)
	ON_COMMAND(ID_SHOW_SELECTED_BRUSH_NUMBER, &CMapDoc::OnMapShowSelectedBrushNumber)
	ON_COMMAND(ID_EDIT_FINDENTITIES, &CMapDoc::OnEditFindEntities)
	ON_UPDATE_COMMAND_UI(ID_EDIT_FINDENTITIES, &CMapDoc::OnUpdateEditFunction)
	ON_COMMAND( ID_TOOLS_DISP_SOLIDDRAW, &CMapDoc::OnToggleDispSolidMask )
	ON_UPDATE_COMMAND_UI( ID_TOOLS_DISP_SOLIDDRAW, &CMapDoc::OnUpdateToggleSolidMask )	
	ON_COMMAND( ID_TOOLS_DISP_DRAWWALKABLE, &CMapDoc::OnToggleDispDrawWalkable )
	ON_UPDATE_COMMAND_UI( ID_TOOLS_DISP_DRAWWALKABLE, &CMapDoc::OnUpdateToggleDispDrawWalkable )	
	ON_COMMAND( ID_TOOLS_DISP_DRAW3D, &CMapDoc::OnToggleDispDraw3D )
	ON_UPDATE_COMMAND_UI( ID_TOOLS_DISP_DRAW3D, &CMapDoc::OnUpdateToggleDispDraw3D )	
	ON_COMMAND( ID_TOOLS_DISP_DRAWBUILDABLE, &CMapDoc::OnToggleDispDrawBuildable )
	ON_UPDATE_COMMAND_UI( ID_TOOLS_DISP_DRAWBUILDABLE, &CMapDoc::OnUpdateToggleDispDrawBuildable )	
	ON_COMMAND( ID_TOOLS_DISP_DRAWREMOVEDVERTS, &CMapDoc::OnToggleDispDrawRemovedVerts )
	ON_UPDATE_COMMAND_UI( ID_TOOLS_DISP_DRAWREMOVEDVERTS, &CMapDoc::OnUpdateToggleDispDrawRemovedVerts )	
    ON_COMMAND(ID_MAP_DIFFMAPFILE, &CMapDoc::OnMapDiff)
	ON_COMMAND(ID_LOGICALOBJECT_LAYOUTGEOMETRIC, &CMapDoc::OnLogicalobjectLayoutgeometric)
	ON_COMMAND(ID_LOGICALOBJECT_LAYOUTDEFAULT, &CMapDoc::OnLogicalobjectLayoutdefault)
	ON_COMMAND(ID_LOGICALOBJECT_LAYOUTLOGICAL, &CMapDoc::OnLogicalobjectLayoutlogical)
	ON_COMMAND(ID_TOOLS_INSTANCES_HIDE, &CMapDoc::OnToolsInstancesHide)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_INSTANCES_HIDE, &CMapDoc::OnUpdateToolsInstancesHide)
	ON_COMMAND(ID_TOOLS_INSTANCES_SHOWTINTED, &CMapDoc::OnToolsInstancesShowTinted)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_INSTANCES_SHOWTINTED, &CMapDoc::OnUpdateToolsInstancesShowTinted)
	ON_COMMAND(ID_TOOLS_INSTANCES_SHOWNORMAL, &CMapDoc::OnToolsInstancesShowNormal)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_INSTANCES_SHOWNORMAL, &CMapDoc::OnUpdateToolsInstancesShowNormal)
#ifdef SLE //// SLE NEW - option to never tint instances
	ON_COMMAND(ID_TOOLS_INSTANCES_NOTINT, &CMapDoc::OnToolsInstancesShowNoTint)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_INSTANCES_NOTINT, &CMapDoc::OnUpdateToolsInstancesShowNoTint)
	ON_COMMAND(ID_TOOLS_INSTANCES_NOTINTALL, &CMapDoc::OnToolsInstancesShowNoTintAll)
	ON_UPDATE_COMMAND_UI(ID_TOOLS_INSTANCES_NOTINTALL, &CMapDoc::OnUpdateToolsInstancesShowNoTintAll)
#endif
	ON_COMMAND(ID_INSTANCES_HIDEALL, &CMapDoc::OnInstancesHideAll)
	ON_COMMAND(ID_INSTANCES_SHOWALL, &CMapDoc::OnInstancesShowAll)
	//}}AFX_MSG_MAP
	...
	ON_COMMAND( ID_VIEW_QUICKHIDE, &CMapDoc::OnQuickHide_HideObjects )
	ON_UPDATE_COMMAND_UI(ID_VIEW_QUICKHIDE, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND( ID_VIEW_QUICKHIDEUNSELECTED, &CMapDoc::OnQuickHide_HideUnselectedObjects )
	ON_UPDATE_COMMAND_UI(ID_VIEW_QUICKHIDEUNSELECTED, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND( ID_VIEW_QUICKUNHIDE, &CMapDoc::OnQuickHide_Unhide )
	ON_UPDATE_COMMAND_UI(ID_VIEW_QUICKUNHIDE, &CMapDoc::OnQuickHide_UpdateUnHide)
	ON_COMMAND( ID_TOGGLE_RADIUSCULLING, &CMapDoc::OnRadiusCulling )
	ON_UPDATE_COMMAND_UI(ID_TOGGLE_RADIUSCULLING, &CMapDoc::OnUpdateRadiusCulling )
	ON_COMMAND( ID_VIEW_QUICKHIDEVISGROUP, &CMapDoc::OnQuickHide_CreateVisGroupFromHidden )
	ON_UPDATE_COMMAND_UI(ID_VIEW_QUICKHIDEVISGROUP, &CMapDoc::OnQuickHide_UpdateCreateVisGroupFromHidden)
#ifdef HAMMER2013_PORT_CORDONS
	ON_COMMAND(ID_TOOLS_NEWCORDON, &CMapDoc::OnNewCordon)
#endif
#ifdef SLE //// SLE NEW - better vertex tool scaling
	ON_COMMAND(ID_VTRANSX_CHANGED, &CMapDoc::OnChangeVertexscale)
	ON_COMMAND(ID_VTRANSY_CHANGED, &CMapDoc::OnChangeVertexscale)
	ON_COMMAND(ID_VTRANSZ_CHANGED, &CMapDoc::OnChangeVertexscale)
	...
	ON_COMMAND(ID_UPDATE_RADIUSCULLING, &CMapDoc::OnRadiusCullingFollowCamera)
	ON_UPDATE_COMMAND_UI(ID_UPDATE_RADIUSCULLING, &CMapDoc::OnUpdateRadiusCullingFollowCamera)
	ON_COMMAND(ID_SEND_SELECTION_TO_SELECTED_VISGROUP, &CMapDoc::OnSendSelectionToSelectedVisgroup) //// SLE NEW - hotkey to instantly send selected objects to selected visgroup

	ON_COMMAND(ID_TOOLS_DROPTOFLOOR, &CMapDoc::OnToolsDropToFloor) //// SLE NEW - simplest physics test
	ON_UPDATE_COMMAND_UI(ID_TOOLS_DROPTOFLOOR, &CMapDoc::OnUpdateEditSelection)

	ON_COMMAND(ID_EDIT_TO3DSKY, &CMapDoc::OnEditTo3dSky) //// SLE NEW: 3d skybox preview
	ON_UPDATE_COMMAND_UI(ID_EDIT_TO3DSKY, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND(ID_EDIT_UNDO3DSKY, &CMapDoc::OnEditUndo3dSky)
	ON_UPDATE_COMMAND_UI(ID_EDIT_UNDO3DSKY, &CMapDoc::OnUpdateEditSelection)

	ON_COMMAND(ID_EDIT_FREEZE_SEL, &CMapDoc::OnEditFreezeSelected)	//// SLE NEW - Freeze/unfreeze
	ON_UPDATE_COMMAND_UI(ID_EDIT_FREEZE_SEL, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND(ID_EDIT_FREEZE_UNSEL, &CMapDoc::OnEditFreezeUnselected)
//	ON_UPDATE_COMMAND_UI(ID_EDIT_FREEZE_UNSEL, &CMapDoc::OnUpdateEditSelection)
	ON_COMMAND(ID_EDIT_UNFREEZE, &CMapDoc::OnEditUnfreeze)
//	ON_UPDATE_COMMAND_UI(ID_EDIT_UNFREEZE, &CMapDoc::OnUpdateEditSelection)

	ON_COMMAND(ID_VIEW_HOME, &CMapDoc::OnViewHome) //// SLE NEW - Home brings you to map origin
	ON_COMMAND(ID_VIEW_PLAYERSTART, &CMapDoc::OnViewPlayerStart) //// SLE NEW - Ctrl + Home cycles you through info_player_start with lowest id
	ON_COMMAND(ID_VIEW_SKYCAMERA, &CMapDoc::OnViewSkyCamera) //// SLE NEW - Home brings you to map origin
	ON_UPDATE_COMMAND_UI(ID_VIEW_HOME, &CMapDoc::OnUpdateViewHome)
	ON_UPDATE_COMMAND_UI(ID_VIEW_PLAYERSTART, &CMapDoc::OnUpdateViewHome)
	ON_UPDATE_COMMAND_UI(ID_VIEW_SKYCAMERA, &CMapDoc::OnUpdateViewHome)
#else
	ON_COMMAND(ID_VSCALE_CHANGED, &CMapDoc::OnChangeVertexscale)
#endif
	END_MESSAGE_MAP()
...
BEGIN_MESSAGE_MAP(CExportDlg, CFileDialog)
	ON_BN_CLICKED(IDC_SAVEVISIBLES, &CExportDlg::OnToggleVisibles)
END_MESSAGE_MAP()
