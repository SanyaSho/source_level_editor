...
BEGIN_MESSAGE_MAP(CTreeList, CTreeCtrl)
	...
	ON_NOTIFY_REFLECT(TVN_BEGINDRAG, &CTreeList::OnBegindrag)
	ON_NOTIFY_REFLECT(TVN_ENDLABELEDIT, &CTreeList::OnEndLabelEdit)
	ON_NOTIFY_REFLECT(TVN_SELCHANGED, &CTreeList::OnSelChange)
	ON_NOTIFY_REFLECT(TVN_KEYDOWN, &CTreeList::OnKeyDown)
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_WM_LBUTTONDBLCLK()
	ON_WM_RBUTTONDOWN()
